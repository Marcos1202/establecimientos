            ...
            @method('PUT')
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        ...
                        style="width: 200px; margin-top:20px;" alt="">
                    </div>
                    ...
                    <legend  class="text-primary">Imágenes Establecimiento: </legend>
                        ...
                        @if (count($imagenes) > 0)
                            @foreach ($imagenes as $imagen)
                                 <input type="hidden" name="" value="{{$imagen->ruta_imagen}}" class="galeria">
                ...
                <input type="submit" class="btn btn-primary mt-3 d-block" value="Guardar Establecimiento">
